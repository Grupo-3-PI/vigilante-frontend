function gerarPDF() {
        ...
        //     pdf.addImage(imgData, 'PNG', 0, 0, 210, 297); // Ajuste as dimensões (A4 em mm)
        //     pdf.save('meu-documento-jspdf.pdf');
        // });
        ...
        //     html2canvas: { scale: 10 }, // Escala para melhor qualidade
        //     jsPDF: { unit: 'in', format: 'letter', orientation: 'portrait' }
        // };

        // html2pdf().from(element).set(opt).save(); // Gera e baixa o PDF
    }
